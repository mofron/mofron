...
try {
    ...
    Why_cmp0_2.option({text: "Why do we need a mofron ?",effect:new Hrzpos('center'),size:'0.5rem',font:"Iceland"});
    Why_cmp0_3.option({effect:new efHrzcnt(65),layout:new HrzCent(85),mainColor:[[240,230,250],{locked:true,forced:true}],baseColor:[[255,253,255],{locked:true,forced:true}],shadow:'0.015rem',style:[{'padding-bottom':'0.2rem','height':'null'},{locked:true,forced:true}]});
    Why_cmp0_4.option({});
    Why_cmp0_5.option({text: "Today web development is tiresome for a sofware engineer. because it must need various things other than programming. For example, design and devices and browser and more...",size:"0.23rem",font:"Quicksand"});
    Why_cmp0_6.option({text: "css tuning and UI/UX design are very important. however, it is a load for a non web designer.",size:"0.23rem",font:"Quicksand"});
    Why_cmp0_7.option({text: "mofron aims to relieve the load of software engineers.",size:"0.23rem",font:"Quicksand"});
    ...
    Whats_cmp0_2.option({text: "What is a mofron?",effect:new Hrzpos('center'),size:"0.5rem",font:"Iceland"});
    ...
    dtl_modsb.option({text: "Module Based",objkey: "dtl_modsb",effect:new Hrzpos('center'),size:"0.5rem",font:"Iceland"});
    Detail_cmp0_3.option({effect:new Hrzpos('center'),src:"//www.slideshare.net/slideshow/embed_code/key/FEMhsyd6vq2yTt",width:"595",height:"485",frameborder:"0",marginwidth:"0",marginheight:"0",scrolling:"no",style:[{'border':'1pxsolid#CCC','border-width':'1px','max-width':'100%'},{locked:true,forced:true}]});
    Detail_cmp0_4.option({baseColor:[[250,250,250],{locked:true,forced:true}],width:'100%'});
    dtl_repl.option({text: "Replaceable",objkey: "dtl_repl",effect:new Hrzpos('center'),size:"0.5rem",font:"Iceland"});
    Detail_cmp0_5.option({effect:new Hrzpos('center'),src:"//www.slideshare.net/slideshow/embed_code/key/1mlaDQYdlDnfwo",width:"595",height:"485",frameborder:"0",marginwidth:"0",marginheight:"0",scrolling:"no",style:[{'border':'1pxsolid#CCC','border-width':'1px','max-width':'100%'},{locked:true,forced:true}]});
    Detail_cmp0_6.option({baseColor:[[250,250,250],{locked:true,forced:true}],width:'100%',style:[{'padding-bottom':'0.5rem'},{locked:true,forced:true}]});
    dtl_utlfnc.option({text: "Utility Functions",objkey: "dtl_utlfnc",effect:new Hrzpos('center'),size:"0.5rem",font:"Iceland"});
    Detail_cmp0_7.option({effect:new Hrzpos('center'),src:"//www.slideshare.net/slideshow/embed_code/key/yJNyDxiyf5JUQA",width:"595",height:"485",frameborder:"0",marginwidth:"0",marginheight:"0",scrolling:"no",style:[{'border':'1pxsolid#CCC','border-width':'1px','max-width':'100%'},{locked:true,forced:true}]});
    ...
    cmp2_1.child([cmp2_2]);
    cmp0_1.option({mainColor:[[240,230,250],{locked:true,forced:true}],effect:[new Fade(true,1000)],title:new Text({text: "mofron",font:"Iceland",style:[{'font-size':'0.45rem'},{locked:true,forced:true}]}),style:[{'-webkit-font-smoothing':'antialiased','-moz-osx-font-smoothing':'grayscale'},{locked:true,forced:true}],theme:{Text:{mainColor:[120,120,120]}},header:new mf.Option({logo:'./img/logo.png',effect:new Shadow({blur:'0.4rem'}),navi:[new Link({text: "Docs",size:'0.2rem',url:['./docs.html',true ]}),new Icon({text: "fab fa-github",size:'0.35rem',event:[new evLink(['https://github.com/mofron/mofron',true])]}),new Icon({text: "fab fa-twitter",size:'0.35rem',event:[new evLink(['https://twitter.com/mofronjs',true])]})]})});
    prjtop.option({baseColor:[[253,245,253],{locked:true,forced:true}],effect:[new Syncwin([true,true],['0px','-50%'])],objkey: "prjtop",theme:{Button:[Button,{accentColor:[240,230,250]}]},text:new mf.Option({text: "The module based frontend framework.",size:'0.6rem',style:[{'z-index':'10'},{locked:true,forced:true}],font:"Iceland"}),button:new mf.Option({text: 'Get Started',clickEvent:stbtn})});
    cmp1_1.option({baseColor:[[250,250,250],{locked:true,forced:true}],style:[{'padding-bottom':'0.5rem'},{locked:true,forced:true}],respsv:{mobile:[{},{layout:[new HrzCent(95)]}],other:[{},{layout:[new HrzCent(35)]}]}});
    cmp1_2.option({baseColor:[[253,245,253],{locked:true,forced:true}],effect:new Hrzpos("center"),layout:new loHoriz(),shadow:"0.015rem",event:[new evLink("./docs.html")]});
    cmp1_3.option({path:"./img/logo.png",height:"1rem",style:[{'margin-left':'0.8rem'},{locked:true,forced:true}]});
    cmp1_4.option({text: "Get Started",size:"0.2rem",mainColor:[[120,120,120],{locked:true,forced:true}],effect:new Vrtpos("center"),style:[{'margin-left':'0.3rem'},{locked:true,forced:true}]});
    cmp2_1.option({mainColor:[[190,190,190],{locked:true,forced:true}],baseColor:[[240,230,250],{locked:true,forced:true}],height:"1rem"});
    cmp2_2.option({text: "Released under the MIT License",effect:new Hrzpos("center"),style:[{'margin-top':'0.2rem'},{locked:true,forced:true}],mainColor:[[120,120,120],{locked:true,forced:true}],size:"0.18rem"});
